...
//    private static final String endpoint = "http://api.androidhive.info/json/glide.json";
    private static final String endpoint = "http://193.124.117.95/api/v1/folderimage/?format=json&subfolder__id=1";
    ...
    public class ParseTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                URL url = new URL("http://193.124.117.95/api/v1/folderimage/?format=json&subfolder__id="+ID);
...
//                    JSONObject url = menu.getJSONObject("url");
                    ...
                    image.setMedium("http://193.124.117.95/"+menu.getString("image"));
                    image.setLarge("http://193.124.117.95/"+menu.getString("image"));
